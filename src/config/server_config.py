...
# This configuration was migrated on 6/2/21 at 11:10:37 PM from the following location: /opt/IBM/WebSphere/AppServer/profiles/AppSrv03
...
AdminConfig.create('JAASAuthData', GlobalSecurityVar, [['alias', 'whydah1Node04/db2'], ['description', ''], ['password', whydah1Node04_db2_password_1], ['userId', whydah1Node04_db2_user_1]])
...
AdminConfigVar_0=AdminConfig.create('JDBCProvider', Node, [['classpath', '/root/db2_driver/db2jcc.jar'], ['description', 'One-phase commit DB2 JCC provider that supports JDBC 3.0. Data sources that use this provider support only 1-phase commit processing, unless you use driver type 2 with the application server for z/OS. If you use the application server for z/OS, driver type 2 uses RRS and supports 2-phase commit processing.'], ['implementationClassName', 'com.ibm.db2.jcc.DB2ConnectionPoolDataSource'], ['name', 'DB2_Universal_JDBC_Driver_Provider'], ['providerType', 'DB2 Universal JDBC Driver Provider'], ['xa', 'false']])
